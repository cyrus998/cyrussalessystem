                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Password Setting</p>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{ route('password.update') }}">
                                    ...
                                    @endif
                                    <div class="mb-3">
                                        <label class="form-label" for="current_password"><strong>Old Password</strong></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm col-12">
                                            <div class="mb-3"><label class="form-label"
                                                    for="password_confirmation"><strong>Confirm Password</strong></label>
