    ...
    <div class="container-fluid">
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <hr>
                <a onclick="printNote('{{ route('sale.print') }}', 'Nota')" class="btn btn-success text-white">Print Note Receipt</a>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        @endif

        <h3 class="text-dark mb-4">Sale</h3>
        <div class="card shadow">
            <div class="card-header py-3">
                <div class="row text-center text-sm-start">
                    <div class="col-sm-5 col-12 mb-3 mb-md-0">
                            <p class="text-primary m-0 fw-bold mt-2">Sales List</p>
                    </div>
                ...
                $('#confirmDelete').click(function() {
                    $.post(url, {
                        ...
                        .done((response) => {
                            ...
                            $('#toast').toast('show');
                            $('#toast .toast-body').text('Successfully deleted data!');
                        })
                        .fail((error) => {
