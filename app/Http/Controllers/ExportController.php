...
class ExportController extends Controller
{
    ...
    public function export($startDate, $endDate)
    {
        ...
        $this->fpdf->Cell(0, 5, 'INCOME REPORT', 0, 1, 'C');
        $this->fpdf->Ln(3);
        $this->fpdf->SetFont('Times', 'B', 14);
        $this->fpdf->Cell(0, 5, 'Periode ' . indonesia_date($startDate, false) . ' to ' . indonesia_date($endDate, false), 0, 1, 'C');
        $this->fpdf->Ln(10);
        ...
        $this->fpdf->Cell(55, 7, 'SALE', 1, 0, 'C');
        $this->fpdf->Cell(55, 7, 'INCOME', 1, 0, 'C');
